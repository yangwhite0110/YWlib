...
namespace GoogleARCore.Examples.HelloAR
{
    ...
    public class HelloARController : MonoBehaviour
    {
        ...
        public void OnGUI()
        {
            if (guiSwitch)
            {
                if (GUI.Button(new Rect(60.0f, 40.0f, 180.0f, 120.0f), "Clear", btnClearStyle))
                {
                    GameObjectHorizontalPlanePrefab = null;
                    guiSwitch = false;
                }
            }
        }
