...
public class NewPlant_3 : MonoBehaviour
{
    ...
    private Rect Bbox()
    {
        ...
        Vector3 plant_center  = transform.GetChild(1).gameObject.GetComponent<MeshRenderer>().bounds.center;
        Vector3 plant_extents = transform.GetChild(1).gameObject.GetComponent<MeshRenderer>().bounds.extents;

        Vector3 pot_center  = transform.GetChild(3).GetChild(1).gameObject.GetComponent<MeshRenderer>().bounds.center;
        Vector3 pot_extents = transform.GetChild(3).GetChild(1).gameObject.GetComponent<MeshRenderer>().bounds.extents;
