...
public class NewPlant_2 : MonoBehaviour
{
    ...
    private Rect Bbox()
    {
        ...
        Vector3 pot_center  = transform.GetChild(3).gameObject.GetComponent<MeshRenderer>().bounds.center;
        Vector3 pot_extents = transform.GetChild(3).gameObject.GetComponent<MeshRenderer>().bounds.extents;
