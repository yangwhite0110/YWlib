...
public class Bottle_0_1 : MonoBehaviour
{
    ...
    private Rect MRRect()
    {
        ...
        Vector3 _1_center  = transform.GetChild(1).gameObject.GetComponent<MeshCollider>().bounds.center;
        Vector3 _1_extents = transform.GetChild(1).gameObject.GetComponent<MeshCollider>().bounds.extents;
        ...
        Vector3[] vertices3d = new Vector3[16]
        {
            ...
            new Vector3(_1_center.x + _1_extents.x, _1_center.y + _1_extents.y, _1_center.z + _1_extents.z),
            new Vector3(_1_center.x + _1_extents.x, _1_center.y + _1_extents.y, _1_center.z - _1_extents.z),
            new Vector3(_1_center.x + _1_extents.x, _1_center.y - _1_extents.y, _1_center.z + _1_extents.z),
            new Vector3(_1_center.x + _1_extents.x, _1_center.y - _1_extents.y, _1_center.z - _1_extents.z),
            new Vector3(_1_center.x - _1_extents.x, _1_center.y + _1_extents.y, _1_center.z + _1_extents.z),
