...
public class NewPlant_7 : MonoBehaviour
{
    ...
    private Rect Bbox()
    {
        ...
        Vector3 plant_center  = transform.GetChild(2).gameObject.GetComponent<MeshRenderer>().bounds.center;
        Vector3 plant_extents = transform.GetChild(2).gameObject.GetComponent<MeshRenderer>().bounds.extents;
