...
public class SportCar100 : MonoBehaviour
{
    ...
    private void SnapshotNoGUI(string _fileTime)
    {
        ...
        StreamWriter swA = new StreamWriter($"/storage/emulated/0/Android/data/com.Yuuu.SC100/A_txt/{_fileTime}.txt");
        ...
        swA.Close();
        StreamWriter swB = new StreamWriter($"/storage/emulated/0/Android/data/com.Yuuu.SC100/B_txt/{_fileTime}.txt");
