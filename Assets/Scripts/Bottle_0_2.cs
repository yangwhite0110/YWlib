...
public class Bottle_0_2 : MonoBehaviour
{
    ...
    private Rect MRRect()
    {
        ...
        Vector3 _0_center  = transform.GetChild(0).gameObject.GetComponent<MeshCollider>().bounds.center;
        Vector3 _0_extents = transform.GetChild(0).gameObject.GetComponent<MeshCollider>().bounds.extents;

        Vector3 _2_center  = transform.GetChild(2).gameObject.GetComponent<MeshCollider>().bounds.center;
        Vector3 _2_extents = transform.GetChild(2).gameObject.GetComponent<MeshCollider>().bounds.extents;

        Vector3[] vertices3d = new Vector3[16]
        {
            new Vector3(_0_center.x + _0_extents.x, _0_center.y + _0_extents.y, _0_center.z + _0_extents.z),
            new Vector3(_0_center.x + _0_extents.x, _0_center.y + _0_extents.y, _0_center.z - _0_extents.z),
            new Vector3(_0_center.x + _0_extents.x, _0_center.y - _0_extents.y, _0_center.z + _0_extents.z),
            new Vector3(_0_center.x + _0_extents.x, _0_center.y - _0_extents.y, _0_center.z - _0_extents.z),
            new Vector3(_0_center.x - _0_extents.x, _0_center.y + _0_extents.y, _0_center.z + _0_extents.z),
            ...
            new Vector3(_2_center.x + _2_extents.x, _2_center.y + _2_extents.y, _2_center.z + _2_extents.z),
            new Vector3(_2_center.x + _2_extents.x, _2_center.y + _2_extents.y, _2_center.z - _2_extents.z),
            new Vector3(_2_center.x + _2_extents.x, _2_center.y - _2_extents.y, _2_center.z + _2_extents.z),
            new Vector3(_2_center.x + _2_extents.x, _2_center.y - _2_extents.y, _2_center.z - _2_extents.z),
            new Vector3(_2_center.x - _2_extents.x, _2_center.y + _2_extents.y, _2_center.z + _2_extents.z),
