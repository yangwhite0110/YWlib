...
public class Worcester : MonoBehaviour
{
    ...
    public List<Rect> Bboxpos = new List<Rect>();
    private void Start()
    {
    ...
    { 
      ...
      XmaxYmax = max;
       ...
       // Rect boundingBox = new Rect(XminYmin.x, XminYmin.y, XmaxYmax.x - XminYmin.x, XmaxYmax.y - XminYmin.y);
       // Bboxpos.Add(boundingBox);
       // return boundingBox;
    ...
    private void SnapshotNoGUI(string _fileTime)
    {
        ...
        /*StreamWriter swC = new StreamWriter($"/storage/emulated/0/Android/data/{packageName}/VOC_txt/{_fileTime}.txt",true);
        ...
        swC.Close();*/
            ...
            //writer.WriteLine($"{className} {standardXmin.ToString("0")} {standardYmin.ToString("0")} {standardXmax.ToString("0")} {standardYmax.ToString("0")}");
